        ...
        <div className="bg-#08dceb-50 mx-4 rounded-lg p-4 mb-3 relative overflow-hidden">
          <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-1">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className={`w-5 h-5 ${
                      i < 4 ? "text-#08dceb-400 fill-current" : "text-gray-300"
                    }`}
                  />
                ))}
              </div>
            ...
            <div className="flex space-x-2">
              <img
                className="w-20 h-20"
                src="https://www.shutterstock.com/image-vector/vector-illustration-material-young-couple-600nw-2216537437.jpg"
                alt=""
              />
            </div>
          </div>
