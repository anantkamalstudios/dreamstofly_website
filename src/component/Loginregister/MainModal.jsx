...
const CollegeduniaApp = () => {
    ...
    return (
        <div className="max-w-sm mx-auto bg-gray-100  relative overflow-hidden">
            ...
            {/* Enhanced Features Modal (Hidden by default) */}
...
// import React, { useState } from 'react';
// import { Search, Edit3, Star, Download, Facebook, Instagram, Twitter, Youtube, Linkedin, Rss, ChevronLeft, ChevronRight } from 'lucide-react';
...
//             {/* Mobile Frame */}
//             <div className="bg-white shadow-xl rounded-3xl mx-4 my-1 overflow-hidden  flex flex-col">
...
//                         <div className="flex items-center justify-between">
//                             <div>
//                                 <div className="text-gray-700 font-medium mb-1">"Write a Review</div>
//                                 <div className="text-gray-700 font-medium mb-2">& Earn Upto ₹500*"</div>
//                                 <div className="flex items-center space-x-1">
//                                     {[...Array(5)].map((_, i) => (
//                                         <Star
//                                             key={i}
...
//                     {/* App Download Section */}
//                     <div className="bg-white mx-4 rounded-lg p-4 mb-6 border border-gray-200">
//                         <h3 className="font-semibold text-gray-800 mb-1">Get Collegedunia App</h3>
...
//                     <div className="bg-white rounded-lg p-6 max-w-sm w-full max-h-[70vh] overflow-y-auto">
//                         <h3 className="font-semibold text-lg mb-4">Select Your Goal</h3>
//                         <div className="space-y-3">
//                             {['Engineering', 'Medical', 'Management', 'Arts & Science', 'Law', 'Other', 'Pharmacy', 'Commerce', 'Design'].map((goal) => (
//                                 <button
//                                     key={goal}
//                                     onClick={() => setSelectedGoal(goal)}
//                                     className={`w-full text-left p-3 rounded-lg border transition-colors ${selectedGoal === goal
