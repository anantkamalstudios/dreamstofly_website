...
const adFormats = [
  {
    ...
    desc: "High-visibility placements across our most-read pages.",
  },
  {
    icon: LayoutGrid,
    title: "Footer Banners",
    desc: "Persistent placements with great CPM efficiency.",
  },
  {
    icon: Link2,
    title: "Text Links",
    desc: "Native-style links blended into relevant content.",
  },
  {
    icon: Bell,
    title: "Opt-in Mailers",
    desc: "Target our verified, opt-in student & parent audience.",
  },
  {
    icon: ServerCog,
    title: "Microsites",
    desc: "A dedicated, SEO-friendly hub for your institute.",
  },
  {
    icon: RotateCw,
    title: "API Integration",
    desc: "Instant lead notifications and CRM handoff.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 text-center">
          ...
          >
            ...
            <h1 className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900">
              Adververtising for{" "}
              <span className="text-sky-600">Study Abroad</span>
            </h1>
            <p className="mt-4 max-w-2xl mx-auto text-base sm:text-lg text-gray-600">
              India’s most innovative and interactive education portal with an
              ergonomically designed interface that maximizes conversions.
            </p>
