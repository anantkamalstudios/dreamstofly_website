    ...
    const mockJobs = [
      {
        ...
        posted: "3 days ago",
        description:
          "We're looking for an experienced frontend developer with React expertise to join our team.",
      ...
      },
      {
        ...
        posted: "1 week ago",
        description:
          "Join our design team to create beautiful, intuitive user experiences for our products.",
        logo: "https://cdn-icons-png.flaticon.com/512/1005/1005141.png",
        company: "DesignHub",
      },
      {
        ...
        posted: "5 days ago",
        description:
          "Help us grow our digital presence and reach new audiences with creative marketing campaigns.",
        logo: "https://cdn-icons-png.flaticon.com/512/1005/1005141.png",
        company: "GrowthLabs",
      },
      {
        ...
        posted: "2 weeks ago",
        description:
          "We need an experienced project manager to oversee our product development lifecycle.",
        logo: "https://cdn-icons-png.flaticon.com/512/1005/1005141.png",
        company: "ManagePro",
      },
      {
        ...
        posted: "1 day ago",
        description:
          "Looking for a backend engineer with Node.js and database expertise to scale our infrastructure.",
        logo: "https://cdn-icons-png.flaticon.com/512/1005/1005141.png",
        company: "DataSystems",
      },
      {
        ...
        posted: "4 days ago",
        description:
          "Create engaging content for our blog and marketing materials that resonates with our audience.",
        logo: "https://cdn-icons-png.flaticon.com/512/1005/1005141.png",
        company: "ContentKing",
      },
    ];
  ...
  const handleFilterChange = (e) => {
    ...
    if (newFilters.department !== "all") {
      results = results.filter(
        (job) => job.department === newFilters.department
      );
    }

    if (newFilters.location !== "all") {
      results = results.filter((job) =>
        job.location.includes(newFilters.location)
      );
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 overflow-x-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center max-w-6xl mx-auto relative z-20">
          <div className="md:w-2/3 mb-8 md:mb-0">
            ...
            >
              ...
              difference. Explore our current openings and find where you fit.
            </motion.p>
            <motion.button
      ...
      >
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <motion.button
              onClick={() =>
                setFilters({ department: "all", location: "all", search: "" })
              }
      ...
      >
        ...
        >
          We're constantly looking for talented people to join our team. Check
          out our most recent job openings below.
        </motion.p>
      ...
      >
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We offer a great work environment and benefits to help you thrive
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            },
            {
              icon: "laptop-house",
              title: "Remote Work",
              desc: "Work from anywhere with our flexible remote policy.",
            },
            {
              icon: "graduation-cap",
              title: "Learning & Development",
              desc: "Annual budget for courses, conferences, and training.",
            },
            {
              icon: "heart",
            ...
            >
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <i
                  className={`fas fa-${benefit.icon} text-blue-600 text-2xl`}
                ></i>
              </div>
      ...
      >
        <div className="bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Sign up for our newsletter to get notified about new job openings
          </p>
