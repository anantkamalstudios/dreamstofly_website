                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden lg:flex items-center space-x-6 flex-1 max-w-4xl ml-8">
                        ...
                        >
                            ...
                            {isGoalOpen && (
                                <div className="absolute top-full left-0 bg-white text-black shadow-2xl rounded-lg py-6 w-96 z-50 mt-2">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button className="hidden lg:flex items-center bg-orange-500 text-white px-4 py-2.5 rounded-lg hover:bg-orange-600 text-sm font-medium">
                            ...
                            Write a Review
                            <div className="ml-2 bg-red-500 text-white text-xs px-2 py-0.5 rounded">Get Upto ₹500</div>
                        </button>
                        ...
                        >
                            ...
                            {isExploreOpen && (
                                <div className="absolute top-full right-0 bg-white text-black shadow-2xl rounded-lg py-6 w-80 z-50 mt-2">
                        ...
                        >
                            ...
                            {isUserOpen && (
                                <div className="absolute top-full right-0 bg-white text-black shadow-2xl rounded-lg py-3 w-90 h-60 z-50 mt-2">
                                    <MainModal />
                                </div>
                            )}
                        </div>
