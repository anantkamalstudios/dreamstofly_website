...
//         setHeroSectionData(data?.data?.data);
//       };
//       fetchApi();
//     } catch (error) {
//       console.log(error);
...
//   const prevSlide = () =>
//     setCurrentSlide(
//       (prev) => (prev - 1 + heroSectionData.length) % heroSectionData.length
//     );
...
//               {heroSectionData[currentSlide]?.university_name}
//             </span>
//             <div className="flex items-center space-x-1">
//               <span className="text-sm">{currentSlide + 1}</span>
//               <span className="text-sm">/</span>
//               <span className="text-sm">{heroSectionData.length}</span>
//             </div>
//           </div>
//         </div>
//       </div>
...
const HeroSection = () => {
  ...
  return (
    <div className="relative h-96 overflow-hidden">
      {/* Background Carousel Container - Only images move */}
      <div
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-black bg-opacity-20">
        <div
          className="h-full bg-blue-500 transition-all duration-700 ease-out"
          style={{
            width: `${((currentSlide + 1) / heroSectionData.length) * 100}%`,
          }}
        />
      </div>
    </div>
