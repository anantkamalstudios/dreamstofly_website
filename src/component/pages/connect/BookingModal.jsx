...
const BookingModal = ({
  ...
  const swiperItems = [
    {
      ...
      image:
        "https://d15gkqt2d16c1n.cloudfront.net/images/svgs/third-slide.svg",
    },
    {
      id: 2,

      image:
        "https://d15gkqt2d16c1n.cloudfront.net/images/svgs/second-slide.svg",
    },
    {
      id: 3,

      image:
        "https://d15gkqt2d16c1n.cloudfront.net/images/svgs/first-slide.svg",
    },
  ];
  ...
  const handleBookSlot = () => {
    alert(
      `Booking confirmed with ${expert.name} on ${selectedDate} at ${selectedTime}!`
    );
    onClose();
  };
  ...
  const prevSwiper = () =>
    setCurrentSwiperIndex(
      (prev) => (prev - 1 + swiperItems.length) % swiperItems.length
    );
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="hidden md:block md:w-2/5 relative">
            ...
            <button
              onClick={prevSwiper}
              className="absolute left-2 top-1/2 transform -translate-y-1/2 p-2 rounded-full bg-white bg-opacity-70 hover:bg-opacity-100"
            >
              <svg
                className="w-6 h-6"
                fill="none"
            ...
            <button
              onClick={nextSwiper}
              className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 rounded-full bg-white bg-opacity-70 hover:bg-opacity-100"
            >
              <svg
                className="w-6 h-6"
                fill="none"
          ...
          <div className="w-full md:w-3/5 p-6">
            ...
            <p className="text-gray-600 mb-6 text-sm">
              Know the basics of the process, docs, scholarships & draft your
              roadmap
            </p>
              ...
              <>
                <div className="flex flex-col md:flex-row gap-4 md:gap-6 mb-6">
                  <div className="flex-1">
                    <h3 className="text-md font-semibold text-gray-800 mb-3">
                      Select Degree you're planning to study
                    </h3>
                    <div className="relative">
                      <select
                        className={`w-full px-6 py-3 rounded-lg text-sm font-medium border ${
                ...
                <div className="mb-1">
                  ...
                  <input
                    ...
                    className={`w-full p-3 border rounded-md focus:ring-2 focus:ring-[#0073df] focus:border-transparent ${
                ...
                <div className="mb-1">
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      className={`w-3/4 p-3 border rounded-md focus:ring-2 focus:ring-[#0073df] focus:border-transparent ${
