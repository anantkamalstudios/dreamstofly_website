...
function DuolingoTest() {
  const modules = [
    {
      title: "Adaptive Test",
      desc: "Questions adjust based on your answers for accurate scoring.",
    },
    {
      title: "Video Interview",
      desc: "Record answers to open-ended questions.",
    },
    {
      title: "Writing Sample",
      desc: "Respond to a prompt for academic writing evaluation.",
    },
  ];
  ...
  const features = [
    {
      title: "At-Home Test",
      desc: "Take the test online anytime from your home.",
    },
    {
      title: "Affordable",
      desc: "Low cost compared to IELTS/TOEFL with the same global acceptance.",
    },
    { title: "Fast Results", desc: "Get results in just 2 days." },
    {
      title: "Global Acceptance",
      desc: "Recognized by 4000+ institutions worldwide.",
    },
  ];
  ...
  const faqs = [
    ...
    { q: "What is the score scale?", a: "Scored between 10–160." },
    {
      ...
      a: "Anywhere with a computer, camera, and internet.",
    },
    {
      q: "Is Duolingo accepted by US universities?",
      a: "Yes, many universities in the US, Canada, UK, and beyond accept it.",
    },
  ];
    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="py-12 px-6 max-w-5xl mx-auto">
        ...
        <p className="text-sm leading-relaxed text-gray-700">
          The Duolingo English Test is a modern, convenient, and affordable test
          accepted by thousands of institutions worldwide. It evaluates English
          proficiency in listening, reading, writing, and speaking — all through
          an online adaptive test and video interview.
        </p>
      </section>
      ...
      <section className="py-12 px-6 max-w-6xl mx-auto">
        <h2 className="text-xl font-semibold text-center mb-8">
          Why Choose Us for Duolingo Prep?
        </h2>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-600 py-12 text-center text-white">
        <h2 className="text-2xl font-semibold mb-4">
          Start Your Duolingo Test Prep with Us
        </h2>
        <motion.button
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
