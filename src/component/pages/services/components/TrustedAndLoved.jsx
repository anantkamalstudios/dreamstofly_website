...
const TrustedAndLoved = ({ stats }) => {
  return (
    <div className="w-full mx-auto py-6 md:py-10 px-6 md:px-20 font-vollkorn">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 md:gap-8">
        {stats.map((stat, index) => (
          <div key={index} className="text-center">
            <div className="text-3xl md:text-5xl font-semibold text-orange-500 mb-4 font-bellefair">
              {stat.number}
            </div>
