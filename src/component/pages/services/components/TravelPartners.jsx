    ...
    <div className="w-full bg-[#0073DF1A] py-8 md:py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <button
            onClick={prevSlide}
            className="absolute left-0 md:-left-10 top-1/2 -translate-y-1/2 md:-translate-x-4 z-10 bg-white rounded-full p-2 md:p-3 shadow-lg hover:bg-blue-50 transition-colors duration-300"
            aria-label="Previous slide"
          >
          ...
          {/* Cards Container */}
          <div className="overflow-hidden mx-6 md:mx-2">
            <div
              className="flex transition-transform duration-500 ease-in-out"
              style={{
                transform: `translateX(-${
            ...
            >
              {partners.map((partner, index) => (
                <div
                  ...
                  style={{ width: `${100 / cardsPerView}%` }}
                >
                  <div className="bg-white rounded-lg shadow-md p-4 md:p-8 h-48 md:h-64 flex flex-col hover:shadow-xl transition-shadow duration-300">
                    {/* IMAGE AT TOP */}
                    <div className="flex items-start w-full">
                      <img
                        src={partner.image}
                    ...
                    {/* BUTTON CENTER IN REMAINING SPACE */}
                    <div className="flex-1 flex justify-center items-center">
                      <button className="px-4 md:px-8 py-2 border-2 border-[#115779] text-[#115779] rounded-md hover:bg-teal-600 hover:text-white transition-colors duration-300 font-medium text-sm md:text-base">
                        Book Now
                      </button>
                    </div>
                  </div>
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 md:-right-10 top-1/2 -translate-y-1/2 md:translate-x-4 z-10 bg-white rounded-full p-2 md:p-3 shadow-lg hover:bg-blue-50 transition-colors duration-300"
            aria-label="Next slide"
          >
