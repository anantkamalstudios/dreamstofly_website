  ...
  return (
    <div className="min-h-full flex items-center justify-center  py-8 ">
      ...
      <div className="w-full mx-auto px-4 sm:px-8 lg:px-28">
        <Heading text="How It Works" className="text-center mb-8 sm:mb-10" />

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          {steps.map((step, index) => (
            <div
              key={index}
              className="p-5 shadow-sm rounded-xl bg-white border border-gray-200 transform-gpu transition-all duration-300 hover:-translate-y-2 hover:shadow-lg"
            >
