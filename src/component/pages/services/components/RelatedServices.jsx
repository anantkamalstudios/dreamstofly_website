        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <div className="w-full mb-6 flex-grow">
              <p className=" text-sm leading-relaxed text-start group-hover:text-white font-poppins">
                {service.description}
              </p>
              <div className="w-24 h-1.5 bg-yellow-400"></div>
            </div>
            <button className="border-2 text-[#193F64] border-[#0073DF] px-6 py-2.5 text-sm font-semibold flex items-center gap-2 hover:text-white transition-colors duration-300 uppercase tracking-wide group-hover:bg-white group-hover:text-[#0073DF] group-hover:border-[#193F64] font-poppins">
              EXPLORE MORE
