...
//   const getFieldsToDisplay = () => formConfig.fields;
...
//             required={required}
//             className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 text-sm"
//           >
...
//             rows={3}
//             className="w-full px-4 py-2 border text-sm border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 resize-none"
//           />
//         );
...
//             onChange={handleInputChange}
//             required={required}
//             className="w-full px-4 py-2 border text-sm border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
//           />
//         );
...
//               className="px-3 py-2 border-r border-gray-300 bg-gray-50 text-sm font-medium text-gray-700 focus:outline-none cursor-pointer"
//               style={{ minWidth: "80px" }}
//             >
...
// ============================================
// ServiceEnquiryForm.jsx (with responsive width fix)
// // ============================================
// import React, { useState } from "react";
// import { Send } from "lucide-react";
...
//   return (
//     <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8 w-full lg:w-[500px]">
//       <div className="text-center mb-2">
//         {formConfig.icon && (
//           <div className="mb-3">
//             <img
...
// ============================================
// ServiceEnquiryForm.jsx - Modern floating labels
// ============================================
import React, { useState } from "react";
