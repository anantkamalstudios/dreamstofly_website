        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-base md:text-lg text-gray-600 max-w-xl mx-auto leading-relaxed">
              End-to-end assistance from visa to accommodation — ensuring a
              smooth transition for your global education journey.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service) => (
              <motion.div
                ...
                className={`relative overflow-hidden bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer ${
                  service.popular ? "ring-2 ring-blue-500/40" : ""
                }`}
              >
                ...
                <div className="p-6">
                  ...
                  <button
                    ...
                    className="w-full py-3 rounded-xl font-medium text-white bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 hover:shadow-xl transition-all duration-300 text-sm flex items-center justify-center gap-2"
                  >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {differentiators.map((item, index) => (
              ...
              >
                ...
                <h3 className="text-base font-semibold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors duration-300">
                  {item.title}
                </h3>
      ...
      <section className="py-12 px-6 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <p className="text-base text-blue-100 mb-8 max-w-xl mx-auto leading-relaxed">
            Join thousands of successful students. Your global education
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-6 text-blue-200 text-sm">
            ...
            <div className="flex items-center gap-2">
              <CheckCircle className="w-4 h-4" /> Expert guidance
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle className="w-4 h-4" /> Success guarantee
            </div>
          </div>
        </div>
      </section>
