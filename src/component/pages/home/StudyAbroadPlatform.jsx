...
//     return (
//         <div className="bg-#08dceb-100 py-16 px-4 md:px-10">
//             {/* Heading */}
...
//                                 {card.desc}
//                             </p>
//                             <button className="bg-[#ff7a00] hover:bg-#08dceb-600 text-white px-6 py-2 rounded-md hover:bg-#08dceb-100 transition">
//                                 {card.btnText}
//                             </button>
//                         </div>
//                     </div>
