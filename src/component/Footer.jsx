      ...
      <div className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        ...
        <div>
          ...
          <ul className="space-y-1.5">
            ...
            <li>
              <Link to="/career" className="hover:text-blue-600 transition-colors">
                Careers
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <h4 className="font-bold text-gray-900 mt-5 mb-3">Bachelors Programs</h4>
          <ul className="space-y-1.5">
            {[
              "BBA Abroad",
              "Business Analytics",
        ...
        <div>
          ...
          <div className="text-gray-600 text-sm leading-snug space-y-1">
            <p className="font-medium">Email: support@dreamstofly.com</p>
            <p>Dreamstofly, Nahata Sport Complex, Sinhagad Road,</p>
            <p>Vadgaon, Maharashtra – 411041</p>
          </div>

          {/* Policies */}
          <div className="flex flex-col mt-3 space-y-1">
            {["Disclaimer", "Refund Policy", "Employee Login"].map((item, index) => (
              <a
                key={index}
                href="#"
