      ...
      <div className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        <div>
          ...
          <ul className="space-y-1.5">
            {[
              {
                name: "CGPA to GPA Conversion",
                slug: "/cgpa-to-gpa-conversion",
              },
              {
                name: "PTE to IELTS Conversion",
                slug: "/pte-to-ielts-conversion",
              },
              { name: "ACT to SAT Score", slug: "/act-to-sat-score" },
              { name: "GMAT Conversion", slug: "/gmat-conversion" },
              {
                name: "SGPA to CGPA Conversion",
                slug: "/sgpa-to-cgpa-conversion",
              },
              {
                name: "SGPA to Percentage Conversion",
